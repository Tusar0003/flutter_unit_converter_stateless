...
import 'package:flutterunitconverter/converter_route.dart';
...
//  const Category(this.name, this.icon, this.color);
  ...
  void _navigateToConverter(BuildContext context) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => ConverterRoute(color: color, units: units)));
  }
